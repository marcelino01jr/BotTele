...
USER_IDENTIFICATION_SYSTEM_PROMPT = (
    ...
    "- 'investasi', 'beli saham', 'topup reksadana', 'beli emas' -> type=investment, category=Investment.\n"
    "- 'narik saham', 'cairin saham', 'cair investasi', 'jual saham', 'dividen', "
    "'bagi hasil' -> type=income, category=Salary (uang yang MASUK ke kantong).\n"
